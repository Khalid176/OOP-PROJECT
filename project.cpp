...
public:
    ...
    bool virtual login(string cnic, string password, bool &) = 0;
};
...
public:
    ...
    bool login(string e_cnic, string e_password, bool &blocked); // forward declaration
    void display()
    {
        cout << "Name : " << name << endl;
...
public:
    ...
    bool login(string cnic, string e_password, bool &k)
    {
...
bool Customer::login(string e_cnic, string e_password, bool &blooooked)
{
    F_M_Customers F_M_C;
    if (F_M_C.F_M_Load("Customers.txt", this, e_cnic, e_password, blooooked))
    {
...
mainmenu:
    ...
    if (choice1 == '1')
    {
        ...
        while (tries < 3)
        {
            ...
            tries++;
            bool k;
            if (admin.login(cnic, password, k))
            {
                logged_in = 1;
                break;
            }
    ...
    if (choice1 == '2')
    {
        ...
        while (login_attempts < 3)
        {
            ...
            try
            {
                if (customer.login(cnic, password, bloocked))
                {
                    break;
                }
                else
